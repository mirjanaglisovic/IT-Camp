...
// Postoji 6 razlicitih vrsta operatora u JavaScript-u:

// 1. Aritmeticki operatori;
// 2. Operatori dedele vrednosti;
// 3. String operatori;
...
// 1.6. Ostatak pri deljenju (%):
console.log(12 % 5);

// Da bi br. bio paran mora ostatak pri deljenju sa 2 biti nula.

// broj % 2 mora biti 0

// Da bi br. bio neparan mora ostatak pri deljenju sa 2 biti razlicit od nule.
...
console.log("55" + 44);
console.log("55" - 44); // Ako string moze da se pretvori u broj JavaScript ce izvrsiti to pretvaranje, pa tek onda oduzimanje ili bilo koju drugu aritmeticku operaciju osim sabiranje.
...
// 4.4. !== Razliciti tip ili razlicita vrednost
...
// 5.2. || Logicko or (ili)
// Ispitati da li je jedan od ponudjenih brojeva paran broj.
